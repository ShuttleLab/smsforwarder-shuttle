...
const SIBLING_SITES: { name: string; host: string; featured?: boolean }[] = [
  { name: "PPT", host: "ppt.shuttlelab.org", featured: true },
  { name: "Note", host: "note.shuttlelab.org", featured: true },
  { name: "Status", host: "status.shuttlelab.org", featured: true },
  { name: "PDF2Word", host: "pdf2docx.shuttlelab.org", featured: true },
  { name: "Clipboard", host: "clipboard.shuttlelab.org" },
  { name: "File", host: "file.shuttlelab.org" },
  { name: "JSON", host: "json.shuttlelab.org" },
  { name: "YAML", host: "yaml.shuttlelab.org" },
  { name: "Message", host: "msg.shuttlelab.org" },
  { name: "Docx", host: "docx.shuttlelab.org" },
  { name: "Image", host: "image.shuttlelab.org" },
  { name: "PDF", host: "pdf.shuttlelab.org" },
  { name: "Diff", host: "diff.shuttlelab.org" },
  { name: "QR", host: "qr.shuttlelab.org" },
  { name: "Base64", host: "base64.shuttlelab.org" },
  { name: "URL", host: "url.shuttlelab.org" },
